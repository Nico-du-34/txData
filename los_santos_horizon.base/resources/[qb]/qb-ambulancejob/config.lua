...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        vector3(353.76, -582.88, 28.76),
        vector3(-251.87, 6334.68, 32.15), -- paleto
    },
    ['duty'] = {
    ...
    ['beds'] = {
        { coords = vector4(352.2, -595.14, 28.37, 97.75),   taken = false, model = 1352121867 },
        { coords = vector4(348.4, -595.75, 28.27, 98.17), taken = false, model = -919002147 },
        { coords = vector4(344.7, -596.31, 28.27, 98.6),  taken = false, model = -919002147 },
        { coords = vector4(340.6, -597.01, 28.27, 98.17),   taken = false, model = -919002147 },
        { coords = vector4(338.52, -597.15, 28.23, 187.11),  taken = false, model = 1632735218 },
        { coords = vector4(328.98, -585.34, 42.78, 226.41), taken = false, model = 1352121867 },
        { coords = vector4(316.06, -596.91, 42.81, 158.91), taken = false, model = -1091386327 },
        --- paleto
        { coords = vector4(-262.46, 6326.5, 31.99, 134.37), taken = false, model = 2117668672 },
        { coords = vector4(-260.11, 6324.2, 31.99, 134.37), taken = false, model = 2117668672 },
        { coords = vector4(-257.73, 6321.82, 31.99, 134.37), taken = false, model = 2117668672 },
        { coords = vector4(-256.42, 6327.83, 31.99, 315.07), taken = false, model = 2117668672 },
        { coords = vector4(-258.73, 6330.06, 31.99, 315.07), taken = false, model = 2117668672 },
        { coords = vector4(-256.04, 6319.51, 31.99, 133.91), taken = false, model = -1091386327 },
        { coords = vector4(-259.57, 6312.4, 31.99, 136.26), taken = false, model = 1631638868 },
    },
    ['jailbeds'] = {
    ...
    ['hospital'] = {
        ...
        {
            ['name'] = 'Paleto Hopital',
            ['location'] = vector3(-251.87, 6334.68, 32.15),
            ['beds'] = {
                { coords = vector4(-262.46, 6326.5, 31.99, 134.37), taken = false, model = 2117668672 },
                { coords = vector4(-260.11, 6324.2, 31.99, 134.37), taken = false, model = 2117668672 },
                { coords = vector4(-257.73, 6321.82, 31.99, 134.37), taken = false, model = 2117668672 },
    ...
    ['stations'] = {
        { label = 'Pillbox Hopital', coords = vector3(304.27, -600.33, 43.28) },
        { label = 'Paleto Hopital', coords = vector3(-261.87, 6322.94, 32.43) }
    }
}
