...
RegisterNetEvent('tc-vending-openShop', function()
    local shop = {
        ...
        {
            header = 'Fermé',
            event = 'qb-menu:client:menuClosed',
            icon = 'fas fa-circle-xmark',
        }, 
    }       
    for k, v in pairs(Config.Shop) do
        local drink = {}
        drink.header = Config.InvPath .. QBCore.Shared.Items[v.drinkName].image .. " width=25px style='margin-right: 10px'> " .. v.drinkLabel
        drink.text = 'Prix: $' .. v.drinkPrice 
        drink.params = {
