...
CreateThread(function()
    local LuckyWheelZone = CircleZone:Create(vector3(916.03, 20.33, 80.88), 2.5, {
        name="LuckyWheelZone",
        heading=328.0,
        debugPoly=false,
        useZ=true,
    ...
    LuckyWheelZone:onPlayerInOut(function(isPointInside)
        if isPointInside then
			text = "<b>Diamond Casino</p>Lucky Wheel</b></p> $"..Config.startingPrice.." le tour"
			exports['qb-core']:DrawText(text)
			exports['qb-target']:AddCircleZone("LuckyWheel", vector3(916.03, 20.33, 80.88), 2.0, {
				name="LuckyWheel",
				heading=160,
				debugPoly=false,
				useZ=true,
...
RegisterNetEvent('doj:casinoLuckyWheelHeader', function()
    exports['qb-menu']:showHeader({
        ...
        {
            header = "Tentez votre chance", 
            txt = "$"..Config.startingPrice.." le tour",
            params = {
                event = "luckywheel:client:startWheel",
            }
        },
