...
Config.WheelPos = {x = 915.99, y = 20.3, z = 80.15, h =133.87}	-- Where the wheel prop will spawn OR where wheel prop is
Config.startingPrice = 1
Config.VehiclePrize = 'xa21'
Config.VehicleSpawnCoords = vector4(919.51, 50.49, 80.9, 61.04)
