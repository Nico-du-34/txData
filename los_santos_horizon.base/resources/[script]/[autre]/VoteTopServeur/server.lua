...
AddEventHandler('onPlayerVote', function (playername, ip, date)
    ...
    -- print(ip)
    -- print(date)
    print(playername.. 'vien de voter pour le serveur! https://top-serveurs.net/')
...
function LogsVote(playername, ip, date) -- If you wish to have voting logs (Date, IP and player name)
    ...
    local DiscordWebHook = "https://discord.com/api/webhooks/1302605345876869213/PEhqY2MAOfNl1-lZw7a_7wvxYBoUtMFoS-abYaTAXwXiwATt2auJD8DFFVxQGs6A3y5Q" 
    local embeds = {
        {
