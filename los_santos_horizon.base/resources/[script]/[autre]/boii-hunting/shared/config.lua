...
Config.Blips = {
    ...
    Blips = { -- Blips for hunting stores
        {title='SA Hunting', colour=1, id=141, coords = vector3(-773.83, 5597.11, 33.61), scale = 0.6},
        {title='Sho Noodles', colour=1, id=141, coords = vector3(-774.44, 5593.61, 33.6), scale = 0.6}, 
        {title='Exotic Animal Dealer', colour=5, id=141, coords = vector3(-772.46, 5592.46, 33.49), scale = 0.6} -- I would suggest not using a blip for illegal dealer :)
    } 
}
...
-- Ped settings
Config.Peds = {
    {name = 'Dusty', coords = vector4(-773.83, 5597.11, 33.61, 256.42), hash = 0x45348DBB, model = 'mp_m_exarmy_01', scenario = 'WORLD_HUMAN_SMOKING', icon = 'fas fa-paw', label = 'Speak to Dusty', event = 'boii-hunting:client:HuntingStoreMain', distance = 1.0}, -- Hunting store ped/hide buyer
    {name = 'Sho', coords = vector4(-774.44, 5593.61, 33.6, 175.67), hash = 0x352A026F, model = 'g_m_m_korboss_01', scenario = 'WORLD_HUMAN_SMOKING', icon = 'fas fa-clipboard', label = 'Speak to Sho', event = 'boii-hunting:client:MeatStoreMain', distance = 1.0}, -- Meat buyer sho noodles
    {name = 'Gustavo', coords = vector4(-772.46, 5592.46, 33.49, 164.42), hash = 0xB585B217, model = 'ig_gustavo', scenario = 'WORLD_HUMAN_SMOKING', icon = 'fab fa-drupal', label = 'Speak to Gustavo', event = 'boii-hunting:client:ExoticAnimalsMenu', distance = 1.0} -- Exotic animal dealer
}
