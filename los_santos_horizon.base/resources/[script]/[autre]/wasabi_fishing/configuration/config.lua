...
Config.fish = {
    { item = 'tuna', label = 'Thon', price = {300, 550}, difficulty = {'medium', 'easy', 'easy'} }, -- name is the item name of the fish(must be in DB of items) / Price is the range of price it will sell to fish buyer / difficulty is how many & how hard skillcheck is
    { item = 'salmon', label = 'Saumon', price = {235, 300}, difficulty = {'medium', 'easy'} },
    { item = 'trout', label = 'Truite', price = {190, 235}, difficulty = {'easy', 'easy'} },
    { item = 'anchovy', label = 'Anchois', price = {100, 190}, difficulty = {'easy'} },
}
