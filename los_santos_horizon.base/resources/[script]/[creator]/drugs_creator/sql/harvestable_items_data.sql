INSERT IGNORE `harvestable_items` (`id`, `name`, `time_to_harvest`, `min_quantity`, `max_quantity`, `icon_type`, `coords`, `scale`, `bounce`, `follow_camera`, `rotate`, `color`, `opacity`, `blip_name`, `blip_sprite`, `blip_color`, `blip_scale`) VALUES 
(1, 'codeine', 4, 2, 8, 1, '{"x":2193.94,"y":5594.27,"z":52.76}', '{"x":2,"y":2,"z":0.5}', 0, 0, 0, '{"g":2,"b":242,"r":226}', 104, NULL, NULL, NULL, NULL),
