...
Config.Society = 'qb-banking' -- 'none', 'esx_society', 'ap-government', 'esx_society' or 'qb-management'
...
Config.BoardObject = 'qs_salesign_01'
...
Config.OpenHouseMenu = 'F5'                   -- Key to open the internal menu of the home
...
Config.CreatedRentableHousesManageable = true 	-- If you set this to false, realestate cannot cancel the lease or expel players.
...
Config.IplData = {
	{
		...
		themes = {
			{ label = 'Moderne',     value = 'modern',     price = 500, image = './assets/img/management/themes/apartment/modern.png' },
			{ label = 'Lunatique',      value = 'moody',      price = 500, image = './assets/img/management/themes/apartment/moody.png' },
			{ label = 'Vibrante',    value = 'vibrant',    price = 500, image = './assets/img/management/themes/apartment/vibrant.png' },
			{ label = 'monochrome', value = 'monochrome', price = 500, image = './assets/img/management/themes/apartment/monochrome.png' },
			{ label = 'Séduisante',  value = 'seductive',  price = 500, image = './assets/img/management/themes/apartment/seductive.png' },
			{ label = 'Royale',      value = 'regal',      price = 500, image = './assets/img/management/themes/apartment/regal.png' },
	...
	},
	{
		...
		defaultTheme = 'warm',
		themes = {
			{ label = 'Chaude',         value = 'warm',         price = 500, image = './assets/img/management/themes/office/warm.png' },
			{ label = 'Classique',    value = 'classical',    price = 500, image = './assets/img/management/themes/office/classical.png' },
			{ label = 'Ancienne',      value = 'vintage',      price = 500, image = './assets/img/management/themes/office/vintage.png' },
			{ label = 'Contraste',     value = 'contrast',     price = 500, image = './assets/img/management/themes/office/contrast.png' },
			{ label = 'Riche',         value = 'rich',         price = 500, image = './assets/img/management/themes/office/rich.png' },
			{ label = 'cool',         value = 'cool',         price = 500, image = './assets/img/management/themes/office/cool.png' },
			{ label = 'Glace',          value = 'ice',          price = 500, image = './assets/img/management/themes/office/ice.png' },
			{ label = 'Conservatrice', value = 'conservative', price = 500, image = './assets/img/management/themes/office/conservative.png' },
			{ label = 'Brillante',     value = 'polished',     price = 500, image = './assets/img/management/themes/office/polished.png' }
		},
...
ActionControls = {
	...
	undo_point = {
		label = 'Annuler Dernier',
		codes = { 25 }
	},
	set_position = {
		label = 'Définir Position',
		codes = { 24 }
	},
	add_garage = {
		label = 'Ajouter Garage',
		codes = { 24 }
	},
	rotate_z = {
		label = 'RotationZ +/-',
	...
	spawn_vehicle = {
		label = 'Spawn Vehicule',
		codes = { 191 }
	},
	leftApt = {
		label = 'Appartement Précédent',
		codes = { 174 }
	},
	rightApt = {
		label = 'Appartement Suivant',
		codes = { 175 }
	},
	testPos = {
		label = 'Test Pos',
