...
Config.RepairWetPhoneNpcAccount = 'cash' -- Choose here the account to pay the technician for repairing the wet phone.
...
Config.Jobs = {
    { job = 'avocat',        name = 'Avocat', img = './img/business/avocat-phone.png'},
    { job = 'police',        name = 'LSPD', img = './img/business/police-phone.png'},
    { job = 'sherif',        name = 'Shérif', img = './img/business/sherif-phone.png'},
    { job = 'ambulance',     name = 'EMS', img = './img/business/ambulance-phone.png'},
    { job = 'ems',           name = 'EMS Paleto', img = './img/business/ems-phone.png'},
    { job = 'realestate',    name = 'Dynasty 8', img = './img/business/realestate-phone.png'},
    { job = 'taxi',          name = 'Taxi', img = './img/business/taxi-phone.png'},
    { job = 'lscustom',      name = 'LS Customs', img = './img/business/lscustom-phone.png'},
    { job = 'bennys',        name = 'Benny\'s Original Motor Works', img = './business/apps/bennys-phone.png'},
    { job = 'redlinegarage', name = 'Red Line Garage', img = './img/business/redlinegarage-phone.png'},
    { job = 'reporter',      name = 'Weazel News', img = './img/business/reporter-phone.png'},
    { job = 'postop',        name = 'Post\'OP', img = './img/business/postop-phone.png'},
}
...
Config.AdminCommandDescription = 'Rechargez votre batterie comme un Elon Musc'
