...
Config = {
    ...
    SeatbeltControl = 'B',  -- Seat belt toggle key (Users can customize this key)
...
Config.GetVehFuel = function(vehicle)
    return exports["cdn-fuel"]:GetFuel(vehicle)--GetVehicleFuelLevel(vehicle)  -- exports["LegacyFuel"]:GetFuel(Veh)
end
