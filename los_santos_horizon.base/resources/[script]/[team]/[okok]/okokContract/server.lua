...
local Webhook = 'https://discord.com/api/webhooks/955541012728651916/Kx9ihIdnuvZDXC6tCO6TsAZNzFJIOM6ngJiqubP0j62_8nyOVO9p_lZ0JANTvrTR6RvJ'
...
AddEventHandler('okokContract:SendContractToBuyer', function(data)
	...
	if Config.RemoveContractAfterUse then
		xPlayer.Functions.RemoveItem('laptop', 1)
	end
end)
