...
var texts = ["REJOINDRE LE SERVEUR", "PREPARATION DES FICHIERS", "ETABLISSEMENT DE LA CONNEXION"];
var currentText = 0;
...
(function welcometext() {
    var welcomes = ['Commencez votre nouvelle aventure passionnante.', 'Découvrez les merveilles de votre nouvelle ville.', 'Ouvrez la porte a un tout nouveau chapitre.', 'Entrez dans un monde de nouvelles possibilites.', 'Embrassez votre nouveau depart.', ];
