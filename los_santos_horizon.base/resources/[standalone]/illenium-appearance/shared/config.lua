...
Config.TargetConfig = {
    ["clothing"] = {
        ...
        icon = "fas fa-tshirt",
        label = "Ouvrir Magasin de vêtements",
        distance = 3
    },
    ["barber"] = {
...
Config.ClothingRooms = {
    ...
    {
        job = "cardealer",
        coords = vector4(-777.79, -240.5, 37.14, 291.46),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "mosley",
        coords = vector4(-17.84, -1662.37, 29.49, 135.96),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "bennys",
        coords = vector4(-194.81, -1331.58, 31.61, 269.18),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "lscustom",
        coords = vector4(-342.59, -162.96, 39.24, 279.03),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "redlinegarage",
        coords = vector4(945.94, -214.4, 72.99, 196.02),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "taxi",
        coords = vector4(901.83, -151.16, 75.32, 57.9),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "realestate",
        coords = vector4(-718.09, 273.14, 84.72, 162.36),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "mcdonald",
        coords = vector4(94.07, 287.33, 110.21, 40.98),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "lsburgershot",
        coords = vector4(-824.53, -792.89, 21.16, 258.18),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "ssburgershot",
        coords = vector4(1448.42, 3572.39, 36.92, 182.92),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "unicorn",
        coords = vector4(156.32, -1338.01, 20.28, 47.01),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "malibu",
        coords = vector4(-797.41, -1222.15, 11.42, 146.32),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "yellowjack",
        coords = vector4(1991.55, 3044.2, 50.55, 328.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "au_siecle_dor",
        coords = vector4(-175.34, 306.37, 100.92, 199.61),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "reporter",
        coords = vector4(-595.0, -920.74, 23.82, 94.01),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "eastcustom",
        coords = vector4(883.81, -2100.57, 30.46, 151.34),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "pawnshop",
        coords = vector4(454.44, -1469.82, 29.29, 241.1),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
